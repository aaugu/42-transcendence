"""
Django settings for livechatProject project.
...
# SECRET_KEY = 'django-insecure-_7w=%xf5$+7735e3fuungvoxqm@fcb80-y48uexqq*nsyasm9l'
SECRET_KEY = os.getenv('LIVECHAT_DJANGO_SECRET_KEY')
