...
class NotificationView(APIView):
	def post(self, request):
		...
		user_nickname = CustomUser.objects.get(id=user_id).nickname
		target_nickname = CustomUser.objects.get(id=target_id).nickname
		...
		url = "http://localhost:8000/livechat/notification/"
		body = {
			"user_1": {
				"user_id": user_id,
