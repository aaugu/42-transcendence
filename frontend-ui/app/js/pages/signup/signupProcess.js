...
export async function signupProcess() {
    ...
    const username = escapeHTML(userData[0].value);
    const nickname = escapeHTML(userData[1].value);
    const email = escapeHTML(userData[2].value);
    const password = escapeHTML(userData[3].value);
    const repeatPassword = escapeHTML(userData[4].value);
    var avatar;
